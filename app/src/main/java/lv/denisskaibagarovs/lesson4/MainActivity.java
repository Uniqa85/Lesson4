...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://api.unsplash.com/photos/?client_id=311ed690d7678d20b8ce556e56d5bf168d6ddf9fa1126e58193d95089d796542";
                ...
                new ArrayAdapter<PhotoItem>(this, 0, photoItems) {
                    ...
                    public View getView(int position,
                        ...
                        if(convertView.getTag() == null) {
                            ...
                            convertView = getLayoutInflater().inflate(R.layout.custom_item_img, null, false);
